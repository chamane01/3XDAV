...
def reproject_to_utm(gdf):
    # Vérifiez si un CRS est défini, sinon, définissez EPSG:4326 par défaut
    if gdf.crs is None:
...
if uploaded_file:
    ...
    if map_object and gdf is not None and buffer_gdf is not None:
        ...
        st.error("Impossible de générer la carte. Vérifiez votre fichier GeoJSON.")
