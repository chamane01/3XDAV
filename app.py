...
# Sidebar avec un bouton "Gestion des missions"
st.sidebar.title("Navigation")
page = st.sidebar.selectbox("Choisir une page", ["Tableau de bord", "Gestion des Missions"])

# Page principale : Tableau de bord
if page == "Tableau de bord":
    st.title("Tableau de Bord")
    st.write("Ici, vous pouvez afficher des graphiques, des cartes ou des informations générales.")
    # Ajoutez ici votre code pour afficher des graphiques, des cartes, etc.

# Page "Gestion des Missions"
elif page == "Gestion des Missions":
